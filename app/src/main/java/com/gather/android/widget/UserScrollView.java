...
public class UserScrollView extends ScrollView {
	 ...
	 */
	private static final float ELASTICITY_COEFFICIENT = 0.9f;
	 ...
	 * 滚动最大高度,超过此高度不再滚动
	 */
	private static int OVERSCROLL_MAX_HEIGHT = 400;
	 ...
	 * 触发事件的高度默认阀值
	 */
	private static final int TRIGGER_HEIGHT = 250;
	...
	public void setMaxOverScrollHigh(int high) {
		OVERSCROLL_MAX_HEIGHT = high;
	}
