...
public class ActDetailVipAdapter extends BaseAdapter {
    ...
    public ActDetailVipAdapter(Context context, ArrayList<UserInfoModel> list) {
    ...
    public View getView(int position, View convertView, ViewGroup arg2) {
        ...
        if (convertView == null) {
            ...
            params.width = (int) (metrics.widthPixels - (context.getResources().getDimensionPixelOffset(R.dimen.act_detail_lable_padding_left) * 2) - (context.getResources().getDimensionPixelOffset(R.dimen.act_detail_item_gridview_padding) * 3)) / 4;
