...
public class KeywordsFlow extends FrameLayout implements OnGlobalLayoutListener {
	...
	private OnWordsClickListener itemClickListener;
	private AnimationOverListener animListener;
	...
	private boolean show() {
		if (width > 0 && height > 0 && vecKeywords != null && vecKeywords.size() > 0 && enableShow) {
			...
			for (int i = 0; i < size; i++) {
				...
				txt.setOnClickListener(new OnKeyWordsListener(keyword));
				txt.setText(keyword);
...
//				txt.setShadowLayer(1, 1, 1, 0xdd696969);
	...
	public void setOnItemClickListener(OnWordsClickListener listener) {
		itemClickListener = listener;
	}

	public class OnKeyWordsListener implements OnClickListener {

		private String text;

		public OnKeyWordsListener(String text) {
			this.text = text;
		}
		...
		public void onClick(View arg0) {
			if (itemClickListener != null) {
				itemClickListener.onWordsListener(text);
			}
		}
	}
	...
	public void setAnimationOverListener(AnimationOverListener animListener) {
