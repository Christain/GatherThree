 ...
 * 我的订单
 */
public class UserOrder extends SwipeBackActivity implements OnClickListener {
	...
	protected void onCreateActivity(Bundle savedInstanceState) {
		...
		this.mTabs[ACT] = (TextView) findViewById(R.id.tvCollection);
		this.mTabs[STRATEGY] = (TextView) findViewById(R.id.tvPay);
